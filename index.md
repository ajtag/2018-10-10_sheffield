...
venue: "Sheffield"        # brief name of host site without address (e.g., "Euphoric State University")
address: "diamond"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latlng: "53.1, -0.5"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
humandate: "today"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "now"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
...
instructor: ["Angus", "Kat", "Ben", "Jen"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["santaslittlehelper"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["admin@email.com"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
